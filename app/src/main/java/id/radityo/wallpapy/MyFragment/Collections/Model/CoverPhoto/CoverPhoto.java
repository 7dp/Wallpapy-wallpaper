package id.radityo.wallpapy.MyFragment.Collections.Model.CoverPhoto;
...
import id.radityo.wallpapy.MyFragment.Collections.Model.CoverPhoto.Author.CoverPhotoAuthor;
...
public class CoverPhoto {
    ...
    @SerializedName("urls")
    @Expose
    public CoverPhotoUrls urls;
    @SerializedName("links")
    @Expose
    public CoverPhotoLinks links;
    ...
    @SerializedName("user")
    @Expose
    public CoverPhotoAuthor coverPhotoAuthor;
    ...
    public void setUrls(CoverPhotoUrls urls) {
        this.urls = urls;
    }
    ...
    public CoverPhotoAuthor getCoverPhotoAuthor() {
        return coverPhotoAuthor;
    }

    public void setCoverPhotoAuthor(CoverPhotoAuthor coverPhotoAuthor) {
        this.coverPhotoAuthor = coverPhotoAuthor;
    }
}
